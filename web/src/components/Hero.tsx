...
type HeroProps = {
  /** Reading time for `/guides/before-you-vibe-code`, in minutes. */
  preflightMinutes: number;
  /** Reading time for `/guides/agentic-products`, in minutes. */
  autonomyMinutes: number;
};

export function Hero({ preflightMinutes, autonomyMinutes }: HeroProps) {
      ...
      <Container className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <h1 className="font-sans tracking-[-0.03em] text-[44px] sm:text-[60px] lg:text-[76px] leading-[0.98] max-w-[17ch] pb-1">
              Ship AI features you can put your{" "}
            ...
            <p className="max-w-[46ch] text-[17px] leading-relaxed text-foreground/70">
              The templates, evals, and launch gates AI PMs use to turn working
              demos into production calls they{" "}
              <span className="text-foreground font-medium">own</span>.
            </p>
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {active === "preflight" ? (
              <PreflightCard minutes={preflightMinutes} />
            ) : (
              <AutonomyCard minutes={autonomyMinutes} />
            )}
          </motion.div>
        </AnimatePresence>
      </div>
...
function PreflightCard({ minutes }: { minutes: number }) {
  return (
    <article
...
function AutonomyCard({ minutes }: { minutes: number }) {
  return (
    <article
